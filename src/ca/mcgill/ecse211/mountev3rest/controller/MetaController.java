...
public class MetaController {
  ...
  private final static double TRACK = 8.45;
  private final static double WHEEL_RAD = 2.05;
  
  public static void main(String[] args) throws OdometerException, PollerException {
    int[][] points = {{3, 3}, {1, 3}, {3, 1}, {1, 1}};
    ...
    DomainController controller = new DomainController(TRACK, WHEEL_RAD);
    controller.testNavigation(points, lcd);
